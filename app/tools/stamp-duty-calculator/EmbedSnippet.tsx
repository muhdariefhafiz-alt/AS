...
const CODE = `<iframe src="https://fair-comparisons.com/embed/stamp-duty-calculator" width="100%" height="720" style="border:1px solid #d7deee;border-radius:14px;max-width:700px" title="Singapore stamp duty calculator (BSD, ABSD, SSD)" loading="lazy"></iframe>`;
      ...
      <div className="fc-row" style={{ justifyContent: "space-between", alignItems: "baseline", gap: 12 }}>
        <div>
          ...
          <p className="muted small" style={{ marginTop: 6 }}>
            Agents and bloggers: paste this on your own site. Free to use, always up to date with IRAS rates.
          </p>
        </div>
