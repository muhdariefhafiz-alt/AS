    ...
    <>
      ...
      <header className="lp-hero" style={{ position: "relative", overflow: "hidden" }}>
        ...
        <div className="fc-wrap" style={{ position: "relative" }}>
          <div className="lp-hero__eyebrow fc-hero-in fc-hero-in--1">Free seller tool</div>
          <h1 className="fc-hero-in fc-hero-in--2">What will you <span className="accent">actually walk away with?</span></h1>
